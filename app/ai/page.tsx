    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <>
          ...
          <Card className="p-5 bg-white shadow-sm border-slate-200">
            ...
            <p className="text-xs text-slate-500 mb-4">
              The RVS is deterministically computed from the Gemini output using this weighted formula.
            ...
            <div className="mt-4 grid md:grid-cols-3 gap-4">
              ...
              <div className="md:col-span-2 space-y-3">
                <p className="text-xs text-slate-600 leading-relaxed">
                  ...
                  directly to <strong>Gemini 2.0 Flash</strong> along with the structured complaint
                  text and retrieved policy context. Gemini performs simultaneous visual and
          ...
          <Card className="p-5 bg-white shadow-sm border-slate-200">
            ...
            <div className="mt-3 grid md:grid-cols-3 gap-6">
              <div className="md:col-span-1 space-y-2">
                ...
                <MetricRow label="Embedding Model" value="gemini-embedding-001" />
      ...
      <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-800 flex items-start gap-2">
        ...
        <span>
          ...
          displayed here are generated by Gemini 2.0 Flash and validated by Zod schema. No automated
...
const PIPELINE_STEPS = [
  ...
  {
    label: "Embedding",
    detail: "gemini-embedding-001 encodes complaint into 768-dim vector",
...
const MODEL_CONFIG = [
  { key: "Provider", value: "Google Gemini API" },
  { key: "Model ID", value: "gemini-2.0-flash" },
  ...
  { key: "Rate limit (free tier)", value: "15 RPM / 1500 RPD" },
];

const EMBEDDING_CONFIG = [
  { key: "Embedding model", value: "gemini-embedding-001" },
...
const RAG_STEPS = [
  ...
  { label: "Query embedding", detail: "gemini-embedding-001 encodes the query string into a 768-dimensional float vector" },
  ...
  { label: "Context injection", detail: "Selected chunks are serialized and injected into the Gemini prompt as [POLICY CONTEXT]" },
  ...
  return (
    <div className="rounded-xl border border-orange-200 bg-orange-50 p-4 space-y-3">
      ...
      <div className="text-[9px] text-orange-700 text-center space-y-0.5">
        <p>Images → Base64 → Gemini Flash</p>
